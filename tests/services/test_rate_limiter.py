from asyncio import wait_for, wait
import time
...
def test_marked_stopped_when_stopped_without_being_started(default_rate_limiter: RateLimiter):
    # Act
...
async def test_function_executed_after_submit_in_async_context(default_async_rate_limiter: RateLimiter):
    # Arrange
